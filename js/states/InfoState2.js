...
Tacit.InfoState2 = function () {
  "use strict";
  Tacit.BaseState.call(this);
};

Tacit.InfoState2.prototype = Object.create(Tacit.BaseState.prototype);
Tacit.InfoState2.prototype.constructor = Tacit.InfoState2;

Tacit.InfoState2.prototype.create = function () {
  "use strict";
  ...
  var info = game.add.image(WIDTH/2, HEIGHT/2 - 30, "game_info2");
...
Tacit.InfoState2.prototype.onNextState = function() {
...
Tacit.InfoState2.prototype.onStartState = function() {
